...
<p align="center"><img css="margin:0 auto;" width="600px" src="Additional Documents/img/RX Dual Power Top.jpg"></p>
<!-- <img css="margin:0 auto;" width="600px" src="Additional Documents/img/RX Dual Power Back.jpg"> -->
...
Commercial devices with this capability are available. Some are quite sophisticated but more bulky (and expensive!). Others are smaller and would flash a high power LED on the model when the backup battery is used but have no telemetry <sup><a href="#note3">3a</a></sup>.
